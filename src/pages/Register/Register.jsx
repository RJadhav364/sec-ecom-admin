...
const Register = () => {
    ...
    const handleSubmitAdminLogin = async () => {
        try {
            const fetchResponse = await fetchData(`${Service_url}/admin-register`, adminLoginDetails.current);
                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            ...
                            <div className="mx-auto max-w-xs">
                                <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" type="text" placeholder="Full Name" onChange={(e) => adminLoginDetails.current.username = e.target.value} />
                                <input className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="email" placeholder="Email" onChange={(e) => adminLoginDetails.current.email = e.target.value} />
                                ...
                                <button className={`mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none ${loading == true ? "cursor-not-allowed" : "cursor-pointer"}`} onClick={handleSubmitAdminLogin} disabled={loading == true}>
